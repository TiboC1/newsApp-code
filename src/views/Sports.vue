<template>
  <div class="about">
    <v-toolbar dark flat>
      <v-icon x-large class="ml-4 mb-3">mdi-soccer</v-icon>
        <h2 class="text-md-h3 ml-4 mb-4" color="blue-grey darken-2">Latest Sports news</h2>
      </v-toolbar>
    <v-container>
...
export default {
  ...
  mounted () {
    axios
      .get('https://newsapi.org/v2/everything?q=sports&language=en&sortBy=publishedAt&apiKey=8a5c505e545b4210a318e5adcf13b6bb')
